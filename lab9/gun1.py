...
def score_counter():
    ...
    """
    score = Default_font.render(str(target.points), True, (0, 0, 0))
...
while not finished:
    ...
    for b in balls_with_time.keys():
        ...
        b.reflection()
        b.move()
        if b.hit_detection(target) and target.live:
            amount_of_balls = Default_font.render('Вы уничтожили цель за ' +
    ...
    target.new_target(a=time_of_hitting,
                      b=target.live,
                      c=amount_of_balls)
